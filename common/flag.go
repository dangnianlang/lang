...
import (
	...
	"test/scan/common/config"
	"test/scan/common/i18n"
)
...
func Flag(Info *HostInfo) error {
	...
	flag.StringVar(&fv.Ports, "port", config.MainPorts, i18n.GetText("flag_ports"))
	...
	// 扫描控制参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&fv.ScanMode, "mode", "all", i18n.GetText("flag_scan_mode"))
	flag.IntVar(&fv.ThreadNum, "c", 600, i18n.GetText("flag_thread_num"))
	flag.Int64Var(&fv.TimeoutSec, "timeout", 3, i18n.GetText("flag_timeout"))
